...
class InternalHolderController extends Controller
{
    // This method for generating the action buttons
    private function generateActionButtons($row)
    {
        $updateButton = "<a type='button' class='updateInternalHolder' data-id='".$row->id."' data-bs-toggle='modal' data-bs-target='#updateInternalModal' ><i class='fa-solid fa-pen-to-square text-success'></i></a>";
        $deleteButton = "<a type='button' class='deleteInternalHolder' data-id='".$row->id."'><i class='fa-solid fa-trash text-danger'></i></a>";
        $viewButton = "<a type='button' class='viewInternalHolder' data-bs-toggle='modal' data-bs-target='#internalHolderDetails' data-id='".$row->id."'><i class='fa-solid fa-eye text-primary'></i></a>";
    ...
    {	
        ...
        if ($request->ajax()) {
            ...
            $query = DB::table('town_holders') 
                ...
                ->where('town_holders.is_community_internal', 1)
                ->select(
                    'town_holders.id',
    ...
    public function store(Request $request)
    {
        ...
        $townHolder->is_community_internal = 1;
        ...
        return redirect()->back()->with('message', 'New Internal Holder Added Successfully!');
    }
    ...
    public function edit($id) 
    {
        ...
        return view('holders.internal.edit', compact('townHolder', 'communities'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/other-holder')->with('message', 'Internal Updated Successfully!');
    }
    ...
    {
        $townHolder = TownHolder::findOrFail($id);
        $community = Community::findOrFail($townHolder->community_id);
