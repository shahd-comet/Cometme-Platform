...
class InternalHolderExport implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
WithStyles
{
    ...
    */
    public function collection()
    {
        $data = DB::table('town_holders')
            ...
            ->select(
                ...
                'communities.english_name as town_english',
                'communities.arabic_name as town_arabic',
    ...
    {
        return ["Holder (English)", "Holder (Arabic)", "Phone Number", "Community (English)", "Community (Arabic)", "Has Internet", 
            "Has Refrigerator"];
    }

    public function title(): string
    {
        return 'Internal Holders';
    }
