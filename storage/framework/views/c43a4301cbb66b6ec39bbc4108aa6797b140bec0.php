    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" enctype='multipart/form-data' id="subCommunityForm"
                action="<?php echo e(url('sub-community')); ?>">
                <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/admin/community/sub/create_sub.blade.php ENDPATH**/ ?>