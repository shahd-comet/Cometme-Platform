...
<?php $__env->startSection('title', 'internet system'); ?>
...
<div class="card">
    <div class="card-content collapse show">
        <div class="card-body">
            <form method="POST" action="<?php echo e(url('internet-system')); ?>" id="internetSystemForm"
                        ...
                        <fieldset class="form-group">
                            ...
                            <select name="internet_system_type_id[]" class="selectpicker form-control"
                                ...
                                <?php $__currentLoopData = $internetSystemTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $internetSystemType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($internetSystemType->id); ?>">
                                        <?php echo e($internetSystemType->name); ?>
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </fieldset>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/system/internet/create.blade.php ENDPATH**/ ?>