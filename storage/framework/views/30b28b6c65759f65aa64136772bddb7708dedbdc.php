        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype='multipart/form-data' id="vendingHistoryForm"
                    action="<?php echo e(url('vending-history')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4">
                            <fieldset class="form-group">
                                ...
                                <select class="selectpicker form-control" name="vendor_id" data-live-search="true" 
                                    ...
                                    <option value="<?php echo e($vendor->id); ?>"><?php echo e($vendor->english_name); ?></option>
...
</script><?php /**PATH C:\Users\User\CometProject\Cometme-Platform\resources\views/vendor/history/create.blade.php ENDPATH**/ ?>