...
<div id="internalHolderDetails" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">
                    <span id="internalHolderModalTitle"></span> Details
                </h1>
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-primary mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="internalHolderEnglishName"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="internalHolderArabicName"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-success mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="communityInternalHolder"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-danger mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="internalHolderPhoneNumber"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
...
</div><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/holders/internal/view.blade.php ENDPATH**/ ?>