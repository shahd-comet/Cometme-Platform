...
<?php $__env->startSection('title', 'All Cameras'); ?>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <form id="collapseExportForm" method="POST" enctype='multipart/form-data' action="<?php echo e(route('camera.export')); ?>">
            <?php echo csrf_field(); ?>
            <div class="card-body">
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-3">
                  <fieldset class="form-group">
                    <select id="exportTypeCollapse" class="selectpicker form-control" data-live-search="true">
                      ...
                      <option value="<?php echo e(route('camera.export')); ?>">All Installed Cameras</option>
                      <option value="<?php echo e(route('camera-additions.export')); ?>">Additions Cameras</option>
                      <option value="<?php echo e(route('replacements.export')); ?>">Replacements Cameras</option>
                    </select>
                  </fieldset>
                </div>
                  ...
                  <fieldset class="form-group">
                    <select id="exportReplacementIncidentType" name="incident_type" class="selectpicker form-control" data-live-search="true">
                      ...
                      <?php $__currentLoopData = $cameraReplacementIncidents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($incident->id); ?>">
                          <?php echo e($incident->english_name ?? $incident->name ?? $incident->id); ?>
            ...
            <div style="display:flex;gap:1rem;align-items:center;">
              <div class="metric">
                <div class="num">
                  ...
                  <?php echo e($summaryData['total_served_communities'] ?? 0); ?>
              ...
              <div class="metric">
                <div class="num">
                  ...
                  <?php echo e(max(0, ((int)($summaryData['total_current'] ?? $summaryData['total_cameras'] ?? 0) - (int)($summaryData['total_repository_cameras'] ?? 0)))); ?>
              ...
              <div class="metric">
                <div class="num">
                  ...
                  <?php echo e($summaryData['total_served_repositories'] ?? 0); ?>
              ...
              <div class="metric">
                <div class="num">
                  ...
                  <?php echo e($summaryData['total_repository_cameras'] ?? 0); ?>
            ...
            <div class="col-md-6">
              <div class="card text-white bg-secondary mb-3 text-center">
                <div class="card-body">
                  ...
                  <p class="card-text display-2"><?php echo e($summaryData['total_current'] ?? 0); ?></p>
                </div>
              </div>
            </div>
              ...
              <div class="card text-white bg-primary mb-3 text-center">
                <div class="card-body">
                  ...
                  <p class="card-text display-2">
                    <?php echo e(($summaryData['total_current'] ?? 0) + ($summaryData['total_damaged'] ?? 0) + ($summaryData['total_returned'] ?? 0)); ?>
            ...
            <div class="col-md-4">
              <div class="card text-white bg-warning mb-3 text-center">
                <div class="card-body">
                  ...
                  <p class="card-text display-3 text-center"><?php echo e($summaryData['total_replaced'] ?? 0); ?></p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card text-white bg-dark mb-3 text-center">
                <div class="card-body">
                  ...
                  <p class="card-text display-3"><?php echo e($summaryData['total_damaged'] ?? 0); ?></p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card text-white bg-danger mb-3 text-center">
                <div class="card-body">
                  ...
                  <p class="card-text display-3"><?php echo e($summaryData['total_returned'] ?? 0); ?></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-2">
              <button type="button" class="btn btn-success"
                <?php if($isAllowed): ?> data-bs-toggle="modal" data-bs-target="#createCommunityCamera"
                <?php else: ?> disabled title="You do not have permission to create cameras" <?php endif; ?>>
                Create New Installed Camera
              </button>
            </div>
            <?php if($isAllowed): ?>
              <?php echo $__env->make('services.camera.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>

            <div class="col-md-2">
              <button type="button" class="btn btn-success"
                <?php if($isAllowed): ?> data-bs-toggle="modal" data-bs-target="#createAddition"
                <?php else: ?> disabled title="You do not have permission to create cameras" <?php endif; ?>>
                Create New Added Camera
              </button>
            </div>
            <?php if($isAllowed): ?>
              <?php echo $__env->make('services.camera.additions.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
          </div>
      ...
      <div class="tab-pane fade" id="replacement" role="tabpanel" aria-labelledby="replacement-tab">
        <div class="my-2">
          <div class="card-body">
            <div>
              <button type="button" class="btn btn-success"
                <?php if($isAllowed): ?> data-bs-toggle="modal" data-bs-target="#createReplacement"
                <?php else: ?> disabled title="You do not have permission to create cameras" <?php endif; ?>>
            ...
            <?php if($isAllowed): ?>
              <?php echo $__env->make('services.camera.replacements.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
      ...
      <div class="tab-pane fade" id="returned" role="tabpanel" aria-labelledby="returned-tab">
        <div class="my-2">
          <div class="card-body">
            <div>
              <button type="button" class="btn btn-success"
                <?php if($isAllowed): ?> data-bs-toggle="modal" data-bs-target="#createReturned"
                <?php else: ?> disabled title="You do not have permission to create returned records" <?php endif; ?>>
                Create Removed Camera Record
              </button>
            </div>

            <?php if($isAllowed): ?>
              <?php echo $__env->make('services.camera.returned.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
  ...
  <script>
    (function () {
      ...
      function initSummary() {
        ...
        let summaryRows = <?php echo json_encode($summaryByRegion ?? [], 15, 512) ?>;
        if (!Array.isArray(summaryRows) || summaryRows.length === 0) {
          summaryRows = [{
            region: 'All',
            total_installed: <?php echo json_encode($summaryData['total_installed'] ?? 0, 15, 512) ?>,
            total_replaced:  <?php echo json_encode($summaryData['total_replaced'] ?? 0, 15, 512) ?>,
            total_added:     <?php echo json_encode($summaryData['total_added'] ?? 0, 15, 512) ?>,
            total_damaged:   <?php echo json_encode($summaryData['total_damaged'] ?? 0, 15, 512) ?>,
            total_returned:  <?php echo json_encode($summaryData['total_returned'] ?? 0, 15, 512) ?>,
            total_current:   <?php echo json_encode($summaryData['total_current'] ?? 0, 15, 512) ?>
          }];
        }
      ...
      function initInstalledTable() {
        ...
        tableInstalled = $('#installedCameraTable').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo e(route('camera.index')); ?>",
            data: function (d) {
      ...
      function initReplacementTable() {
        ...
        tableReplacement = $('#replacementTableAll').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo e(route('replacement.index')); ?>",
            data: function (d) {
              d.region_filter = $('#filterByRegionInstalled').val();
              d.community_filter = $('#filterByCommunityInstalled').val();
              d.date_filter = $('#filterByDateInstalled').val();
      ...
      function initAdditionTable() {
        ...
        tableAddition = $('#additionTableAll').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo e(route('camera-additions.index')); ?>",
            data: function (d) {
              d.region_filter = $('#filterByRegionInstalled').val();
              d.community_filter = $('#filterByCommunityInstalled').val();
              d.date_filter = $('#filterByDateInstalled').val();
      ...
      function initReturnedTable() {
        ...
        tableReturned = $('#returnedTableAll').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo e(route('camera-returned.index')); ?>",
            data: function (d) {
              d.region_filter = $('#filterByRegionInstalled').val();
              d.community_filter = $('#filterByCommunityInstalled').val();
              d.date_filter = $('#filterByDateInstalled').val();
      ...
      $(function () {
        ...
        $('#exportTypeCollapse').on('change', function () {
          ...
          var replacementsRoute = '<?php echo e(route('replacements.export')); ?>';
        ...
        $('#collapseExportButton').on('click', function () {
          ...
          if (isDefault) url = '<?php echo e(route('camera.export')); ?>';
      ...
      $(document).on('click', '.updateCamera', function () {
        ...
        window.location.href = "<?php echo e(url('replacements')); ?>/" + id + "/edit";
      });

      $('#installedCameraTable').on('click', '.viewCameraCommunityButton', function () {
        var id = $(this).data('id');
        window.open("<?php echo e(url('camera')); ?>/" + id);
      });

      $('#installedCameraTable').on('click', '.updateCameraCommunity', function () {
        var id = $(this).data('id');
        window.location.href = "<?php echo e(url('camera')); ?>/" + id + "/edit";
      });
      ...
      $('#installedCameraTable').on('click', '.deleteCameraCommunity', function () {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "<?php echo e(route('deleteCameraCommunity')); ?>",
              type: 'get',
              data: { id: id },
      ...
      $('#replacementTableAll').on('click', '.deleteCamera', function () {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "<?php echo e(route('replacement.delete')); ?>",
              type: 'POST',
      ...
      $('#additionTableAll').on('click', '.updateAddition', function () {
        var id = $(this).data('id');
        window.location.href = "<?php echo e(url('camera-additions')); ?>/" + id + "/edit";
      });
      ...
      $('#additionTableAll').on('click', '.deleteAddition', function () {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "<?php echo e(route('camera-additions.destroy')); ?>",
              type: 'POST',
              data: { _token: "<?php echo e(csrf_token()); ?>", id: id },
              success: function (response) {
                if (response.success == 1) {
      ...
      $('#returnedTableAll').on('click', '.deleteReturned', function () {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "<?php echo e(route('camera-returned.destroy')); ?>",
              type: 'POST',
              data: { _token: "<?php echo e(csrf_token()); ?>", id: id },
              success: function (response) {
                if (response.success == 1) {
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/services/camera/all_cameras.blade.php ENDPATH**/ ?>