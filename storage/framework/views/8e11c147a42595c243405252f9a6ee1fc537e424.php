    ...
    <div class="timeline-event card p-0" data-aos="fade-right">
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled">
                <?php if(count($missingCommunityRepresentatives) > 0): ?>
                <li class="d-flex justify-content-start align-items-center text-danger mb-3">
                    ...
                    <div class="ps-3 border-start"> 
                        ...
                        <h5 class="mb-0"><?php echo e($missingCommunityRepresentatives->count()); ?></h5>
                    </div>
                </li>
                <?php echo $__env->make('actions.admin.community.missing_representatives', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
                <?php if(count($communityWaterService) > 0): ?>
                <li class="d-flex justify-content-start align-items-center text-info mb-3">
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($communityWaterService->count()); ?></h5>
                    </div>
                </li>
                <?php echo $__env->make('actions.admin.community.water_service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
                <?php if(count($communityWaterServiceYear) > 0): ?>
                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($communityWaterServiceYear->count()); ?></h5>
                    </div>
                </li>
                <?php echo $__env->make('actions.admin.community.water_service_year', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
                <?php if(count($communityInternetService) > 0): ?>
                <li class="d-flex justify-content-start align-items-center text-success mb-3">
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($communityInternetService->count()); ?></h5>
                    </div>
                </li>
                <?php echo $__env->make('actions.admin.community.internet_service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
                <?php if(count($communityInternetServiceYear) > 0): ?>
                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                    <a type="button" data-bs-toggle="modal"
                        title="view communities that missing internet year"
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($communityInternetServiceYear->count()); ?></h5>
                    </div>
                </li>
                <?php echo $__env->make('actions.admin.community.internet_service_year', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            </ul>
        </div>
            ...
            <ul class="list-unstyled">
                <li class="d-flex justify-content-start align-items-center text-danger mb-3">
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($missingPhoneNumbers); ?></h5>
                    </div>
                </li>
                <li class="d-flex justify-content-start align-items-center text-info mb-3">
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($missingAdultNumbers); ?></h5>
                    </div>
                </li>
                <li class="d-flex justify-content-start align-items-center text-primary mb-3">
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($missingChildrenNumbers); ?></h5>
                    </div>
                </li>
                <li class="d-flex justify-content-start align-items-center text-primary mb-3">
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($missingMaleNumbers); ?></h5>
                    </div>
                </li>
                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                    ...
                    <div class="ps-3 border-start">
                        ...
                        <h5 class="mb-0"><?php echo e($missingFemaleNumbers); ?></h5>
                    </div>
                </li>
            </ul>
        </div>
...
<li class="timeline-item mb-md-4 mb-5 timeline-item-right">
    ...
    <div class="timeline-event card p-0" data-aos="fade-right">
        ...
        <div class="card-body pb-0"> 
            <?php if(count($missingSchoolDetails) > 0): ?>
            <p>You've <?php echo e($missingSchoolDetails->count()); ?>
            ...
            <?php echo $__env->make('actions.admin.public.school', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        </div>
...
<li class="timeline-item timeline-item-left" >
    ...
    <div class="timeline-event card p-0" data-aos="fade-right">
        ...
        <?php if(count($missingEnergySystems) > 0): ?>
        <div class="card-body pb-3 pt-0">
            ...
            <?php $__currentLoopData = $missingEnergySystems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $missingEnergySystem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <ul class="list-group">
                <li class="d-flex list-group-item" style="margin-top:9px">
                    <span> <?php echo e($missingEnergySystem->english_name); ?>  / 
                        <?php echo e($missingEnergySystem->name); ?>
                    </span>   
                </li>
            </ul>
...
<?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/actions/admin/internal/index.blade.php ENDPATH**/ ?>