...
<div id="viewVendingHistoryModal" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">
                    <span id="vendingHistoryModalTitle"></span> Details
                </h1>
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-primary mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Vending Point</small>
                                                        <h6 class="mb-0" id="vendingPointEnglishName"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-success mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="vendingPointPhoneNumber"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-secondary mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="vendingPointRegion"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-warning mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="vendingPointUsername"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-info mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="vendingPointArabicName"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-danger mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="vendingPointAdditionalphoneNumber"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="vendingPointLocation"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-primary mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="vendingPointVisitDate"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-success mb-3">
                                                    <i class="bx bx-calendar bx-sm me-3"></i>
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Visit Date From</small>
                                                        <h6 class="mb-0" id="vendingPointVisitFrom"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-warning mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Total Amount</small>
                                                        <h6 class="mb-0" id="vendingPointTotalAmount"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-danger mb-3">
                                                    <i class="bx bx-shekel bx-sm me-3"></i>
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Remaining Balance</small>
                                                        <h6 class="mb-0" id="vendingPointRemainingBalance"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-warning mb-3">
                                                    <i class="bx bx-user bx-sm me-3"></i>
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Visit By</small>
                                                        <h6 class="mb-0" id="vendingPointVisitBy"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-secondary mb-3">
                                                    <i class="bx bx-calendar bx-sm me-3"></i>
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Visit Date To</small>
                                                        <h6 class="mb-0" id="vendingPointVisitTo"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-info mb-3">
                                                    <i class="bx bx-shekel bx-sm me-3"></i>
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Amount Collected</small>
                                                        <h6 class="mb-0" id="vendingPointAmountCollected"></h6>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="vendingHistoryNotes"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
...
</div><?php /**PATH C:\Users\User\CometProject\Cometme-Platform\resources\views/vendor/history/show.blade.php ENDPATH**/ ?>