...
<?php $__env->startSection('title', 'Create Agriculture Holder'); ?>
...
.select2-container--bootstrap-5 .select2-results__option {
    ...
    <?php if(old('size_of_herds')): ?>
        calculateAzollaSystems(<?php echo e(old('size_of_herds')); ?>);
    <?php endif; ?>
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('argiculture-user.store')); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $communities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $community): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e($community->id); ?>" 
                                            ...
                                            <?php echo e(old('community_id') == $community->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('requested_date', date('Y-m-d'))); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select <?php $__errorArgs = ['agriculture_installation_types_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="agriculture_installation_types_id" name="agriculture_installation_types_id">
                                    ...
                                    <?php if(!empty($agricultureInstallationTypes) && count($agricultureInstallationTypes) > 0): ?>
                                        ...
                                        <?php $__currentLoopData = $agricultureInstallationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <option value="<?php echo e($inst->id); ?>" <?php echo e(old('agriculture_installation_types_id') == $inst->id ? 'selected' : ''); ?>><?php echo e($inst->english_name ?? $inst->arabic_name ?? ('#'.$inst->id)); ?></option>
                                ...
                                <?php $__errorArgs = ['agriculture_installation_types_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="agriculture_system_cycle_id" name="agriculture_system_cycle_id">
                                    ...
                                    <?php $__currentLoopData = $agricultureSystemCycles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cycle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="<?php echo e($cycle->id); ?>" <?php echo e(old('agriculture_system_cycle_id') == $cycle->id ? 'selected' : ''); ?>><?php echo e($cycle->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select placeholder="Select Systems" class="form-select <?php $__errorArgs = ['selected_system_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="selected_system_ids" name="selected_system_ids[]" multiple>
                            ...
                            <?php if(isset($agricultureSystems) && $agricultureSystems->count()): ?>
                                ...
                                <?php $__currentLoopData = $agricultureSystems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e($sys->id); ?>" <?php echo e((collect(old('selected_system_ids',[]))->contains($sys->id)) ? 'selected' : ''); ?>><?php echo e($sys->name ?? optional($sys->azollaType)->name ?? 'System #' . $sys->id); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <!--       class="form-control <?php $__errorArgs = ['azolla_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" -->
                            ...
                            <!--       value="<?php echo e(old('azolla_unit')); ?>"-->

                            <!--       readonly-->

                            <!--       placeholder="Will be calculated based on herd size">-->

                            <!--<?php $__errorArgs = ['azolla_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>-->
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="ms-3">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="manual_entry" name="manual_entry" value="1" <?php echo e(old('manual_entry') ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" 
                                   ...
                                   class="form-control <?php $__errorArgs = ['size_of_herds'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('size_of_herds')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Calculated Systems Information (commented out) -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" 
                                       ...
                                       class="form-control <?php $__errorArgs = ['size_of_goat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('size_of_goat')); ?>"

                                       min="0"

                                       placeholder="Enter number of goats">

                                <?php $__errorArgs = ['size_of_goat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" 
                                       ...
                                       class="form-control <?php $__errorArgs = ['size_of_cow'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('size_of_cow')); ?>"

                                       min="0"

                                       placeholder="Enter number of cows">

                                <?php $__errorArgs = ['size_of_cow'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" 
                                       ...
                                       class="form-control <?php $__errorArgs = ['size_of_camel'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('size_of_camel')); ?>"

                                       min="0"

                                       placeholder="Enter number of camels">

                                <?php $__errorArgs = ['size_of_camel'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" 
                                       ...
                                       class="form-control <?php $__errorArgs = ['size_of_chicken'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('size_of_chicken')); ?>"

                                       min="0"

                                       placeholder="Enter number of chickens">

                                <?php $__errorArgs = ['size_of_chicken'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>">
            ...
            <option value="A" <?php echo e(old('area_of_installation') == 'A' ? 'selected' : ''); ?>>A</option>

            <option value="B" <?php echo e(old('area_of_installation') == 'B' ? 'selected' : ''); ?>>B</option>

            <option value="C" <?php echo e(old('area_of_installation') == 'C' ? 'selected' : ''); ?>>C</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="radio" name="area_type" id="area_type_area" value="area" <?php echo e((old('area_type', 'area') == 'area') ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="radio" name="area_type" id="area_type_alternative" value="alternative" <?php echo e((old('area_type') == 'alternative') ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-4 area-number-col" style="display: <?php echo e((old('area_type', 'area') == 'area') ? 'block' : 'none'); ?>;">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-8 alternative-area-col" style="display: <?php echo e((old('area_type') == 'alternative') ? 'block' : 'none'); ?>;">
...
unset($__errorArgs, $__bag); ?>"
                                          ...
                                          placeholder="Enter alternative area"><?php echo e(old('alternative_area')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <a href="<?php echo e(route('argiculture-user.index')); ?>" class="btn btn-outline-secondary">
...
<?php $__currentLoopData = $households; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $household): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    householdsByCommunity[<?php echo e($household->community_id); ?>].push({ id: <?php echo e($household->id); ?>, name: <?php echo json_encode($household->english_name); ?>, size_of_herd: <?php echo json_encode($household->size_of_herd); ?> });

    householdsById[<?php echo e($household->id); ?>] = { id: <?php echo e($household->id); ?>, community_id: <?php echo e($household->community_id); ?>, name: <?php echo json_encode($household->english_name); ?>, size_of_herd: <?php echo json_encode($household->size_of_herd); ?> };
...
$(document).ready(function() {
    ...
    function setManualEntryState() {
        ...
        if (manual) {
            ...
            // automatic calculation disabled per request
    ...
    <?php if(old('community_id')): ?>
        ...
        setTimeout(function() {
            ...
            $('#household_id').val('<?php echo e(old('household_id')); ?>').trigger('change');
    ...
    <?php if(old('number_of_people')): ?>

        $('#number_of_people').val('<?php echo e(old('number_of_people')); ?>');
...
<?php $__env->startSection('page-fallback-script'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/agriculture/user/create.blade.php ENDPATH**/ ?>