...
<?php $__env->startSection('title', 'Agriculture User Details'); ?>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo e(route('argiculture-user.edit', $agricultureUser->id)); ?>" class="btn btn-primary btn-sm">
                        <i class="bx bx-edit"></i> Edit
                    </a>
                    <a href="<?php echo e(route('argiculture-user.index')); ?>" class="btn btn-secondary btn-sm">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <p class="form-control-plaintext"><?php echo e(optional($agricultureUser->household)->english_name ?? '—'); ?></p>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Community</label>
                            <p class="form-control-plaintext"><?php echo e(optional($agricultureUser->community)->english_name ?? '—'); ?></p>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Status</label>
                            <p class="form-control-plaintext"><?php echo e(optional($agricultureUser->agricultureHolderStatus)->english_name ?? '—'); ?></p>
                        </div>

                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                <label class="form-label fw-bold">Requested Date</label>
                                <p class="form-control-plaintext"><?php echo e($agricultureUser->requested_date ? \Carbon\Carbon::parse($agricultureUser->requested_date)->format('Y-m-d') : '—'); ?></p>
                            </div>
                            <div class="col-sm-6 mb-3">
                                <label class="form-label fw-bold">Confirmation Date</label>
                                <p class="form-control-plaintext"><?php echo e($agricultureUser->confirmation_date ? \Carbon\Carbon::parse($agricultureUser->confirmation_date)->format('Y-m-d') : '—'); ?></p>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold">System Cycle</label>
                            <p class="form-control-plaintext"><?php echo e(optional($agricultureUser->agricultureSystemCycle)->name ?? '—'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label fw-bold">Type of Installation</label>
                                <p class="form-control-plaintext">
                                    <?php echo e(isset($agricultureUser->agriculture_installation_type_id) && $agricultureUser->agriculture_installation_type_id
                                ...
                                <?php if(!empty($contributionBreakdown)): ?>
                                    <div class="mt-2">
                                        <strong>Per-system Contribution</strong>
                                        <ul class="mb-0">
                                            <?php $__currentLoopData = $contributionBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <?php echo e($b['system_name'] ?? ('#'.$b['system_id'])); ?> :
                                                    <strong><?php echo e($b['amount'] !== null ? number_format($b['amount'],0) . '₪' : '—'); ?></strong>
                                                    <?php if(empty($b['system_type'])): ?> <small class="text-muted">(unknown type)</small><?php endif; ?>
                                                </li>
                        ...
                        <div class="mb-3">
                            ...
                            <p class="form-control-plaintext"><?php echo e($agricultureUser->area_of_installation ?? '—'); ?></p>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <p class="form-control-plaintext"><?php echo e($agricultureUser->size_of_herds ?? 0); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <p class="form-control-plaintext mb-0">
                                Goats: <?php echo e($agricultureUser->size_of_goat ?? 0); ?><br>
                                Cows: <?php echo e($agricultureUser->size_of_cow ?? 0); ?><br>
                                Camels: <?php echo e($agricultureUser->size_of_camel ?? 0); ?><br>
                                Chickens: <?php echo e($agricultureUser->size_of_chicken ?? 0); ?>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <?php if($sharedRows->count() > 0): ?>
                            <div class="table-responsive">
                                <table class="table table-sm table-striped">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $sharedRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shared): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <?php if(!empty($useRaw)): ?>
                                                    <td><?php echo e(isset($shared->household_id) ? (App\Models\Household::find($shared->household_id)->english_name ?? '—') : '—'); ?></td>
                                                    <td><?php echo e($shared->size_of_herds ?? 0); ?></td>
                                                <?php else: ?>
                                                    <td><?php echo e(optional($shared->household)->english_name ?? '—'); ?></td>
                                                    <td><?php echo e($shared->size_of_herds ?? 0); ?></td>
                                                    <td><?php echo e(optional($shared->created_at)->format('Y-m-d H:i:s') ?? '—'); ?></td>
                                                <?php endif; ?>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                    ...
                    <div class="card-body">
                        ...
                        <?php if($systems->count() > 0): ?>
                            <?php $__currentLoopData = $systems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="card mt-2">
                                    <div class="card-header">
                                        <strong><?php echo e(optional($sys)->name ?? optional($sys)->english_name ?? 'Unnamed System'); ?></strong>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                        ...
                                        <?php if($holderComponents->count() > 0): ?>
                                            <div class="table-responsive">
                                                <table class="table table-sm table-striped">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $holderComponents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><?php echo e($compName); ?></td>
                                                                <td><?php echo e($modelName); ?></td>
                                                                <td><?php echo e($qty); ?></td>
                                                                <td><?php echo e($up); ?></td>
                                                                <td class="text-end">
                                                                    <a href="<?php echo e(route('argiculture-user.systems.components.edit', ['holder' => $agricultureUser->id, 'system' => optional($sys)->id])); ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                                                                    <form method="post" action="<?php echo e(route('argiculture-user.systems.components.delete', ['holder' => $agricultureUser->id, 'system' => optional($sys)->id, 'holder_component' => $hc->id])); ?>" style="display:inline-block" onsubmit="return confirm('Remove this holder-specific component?');">
                                                                        <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php if($systemComponents->count() > 0): ?>
                                                <p class="text-muted mb-2 ">Showing system components for <b><?php echo e(optional($agricultureUser->household)->english_name ?? '—'); ?>.</b></p>
                                                <div class="table-responsive">
                                                    <table class="table table-sm table-striped">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                            <?php $__currentLoopData = $systemComponents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php
                                                                ...
                                                                ?>
                                                                <tr>
                                                                    <td><?php echo e(optional(App\Models\AgricultureComponent::find($compId))->english_name ?? '—'); ?></td>
                                                                    <td><?php echo e(optional(App\Models\AgricultureComponentModel::find($modelId))->model ?? '—'); ?></td>
                                                                    <td><?php echo e($qty ?? '—'); ?></td>
                                                                    <td><?php echo e($up ?? '—'); ?></td>
                                                                    <td class="text-end">
                                                                        <a href="<?php echo e(route('argiculture-user.systems.components.edit', ['holder' => $agricultureUser->id, 'system' => optional($sys)->id])); ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($holderDonors->count() > 0): ?>
                            <div class="list-group">
                                <?php $__currentLoopData = $holderDonors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="fw-medium"><?php echo e(optional($hd->donor)->donor_name ?? optional($hd)->donor_name ?? 'Unknown'); ?></div>
                                            <small class="text-muted"><?php echo e(optional($hd->donor)->email ?? optional($hd)->email ?? ''); ?></small>
                                        </div>
                                        <div class="text-end">
                                            <small class="text-muted">Joined: <?php echo e(optional($hd->created_at)->format('Y-m-d') ?? '—'); ?></small>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card p-2 border-0 bg-light">
                            <div class="card-body p-3">
                                ...
                                <p class="mb-0 text-muted"><?php echo e($agricultureUser->notes ?? '—'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/agriculture/user/show.blade.php ENDPATH**/ ?>