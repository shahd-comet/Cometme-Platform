<div id="createActivistHolderModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="POST" enctype='multipart/form-data' action="<?php echo e(url('activist-holder')); ?>" id="activistHoldersForm">
            <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/holders/activist/create.blade.php ENDPATH**/ ?>