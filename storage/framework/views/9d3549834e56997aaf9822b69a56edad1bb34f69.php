...
<div id="createAddition" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('camera-additions.store')); ?>">
                <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="nvr_camera_id" name="nvr_camera_id" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $nvrs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nvr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/services/camera/additions/create.blade.php ENDPATH**/ ?>