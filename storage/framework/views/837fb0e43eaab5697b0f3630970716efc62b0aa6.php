<div id="createInternalHolderModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Create New Holder for Internal</h4>
                <button type="button" class="close" data-bs-dismiss="modal">&times;</button> 
            </div>
            <form method="POST" enctype='multipart/form-data' action="<?php echo e(url('internal-holder')); ?>" id="internalHoldersForm">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <fieldset class="form-group">
                                ...
                                <select class="selectpicker form-control" name="community_id" 
                                    data-live-search="true" id="communityInternalSelected">
                            ...
                            <div id="community_internal_id_error" style="color: red;"></div>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6">
...
<script>
    ...
    $('#internalHoldersForm').on('submit', function (event) {

        event.preventDefault(); 

        let valid = true;

        var communityValue = $('#communityInternalSelected').val();

        if (communityValue == null) {

            $('#community_internal_id_error').html('Please select a community!'); 
            return false;
        } else  if (communityValue != null) {

            $('#community_internal_id_error').empty();
        }
...
</script><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/holders/internal/create.blade.php ENDPATH**/ ?>