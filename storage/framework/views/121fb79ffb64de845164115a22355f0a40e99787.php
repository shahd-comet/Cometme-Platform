            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="POST" enctype='multipart/form-data' 
                        action="<?php echo e(route('all-maintenance.export')); ?>">
                        <?php echo csrf_field(); ?> 
                        <div class="card-body"> 
                            <div class="row">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <select name="service_id" class="selectpicker form-control" 
                                            ...
                                            <?php $__currentLoopData = $serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($serviceType->id); ?>"><?php echo e($serviceType->service_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select> 
                                    </fieldset>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-3">
                                    <fieldset class="form-group">
                                        ...
                                        <select name="maintenance_status_id" class="selectpicker form-control" 
                                            data-live-search="true">
                                            <option disabled selected>Choose one...</option>
                                            <?php $__currentLoopData = $maintenanceStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $maintenanceStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($maintenanceStatus->id); ?>"><?php echo e($maintenanceStatus->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select> 
                                    </fieldset>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-3">
                                    <fieldset class="form-group">
                                        ...
                                        <select name="maintenance_type_id" class="selectpicker form-control" 
                                            data-live-search="true">
                                            <option disabled selected>Choose one...</option>
                                            <?php $__currentLoopData = $maintenanceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $maintenanceType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($maintenanceType->id); ?>"><?php echo e($maintenanceType->type); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select> 
                                    </fieldset>
                                </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3">
                    <fieldset class="form-group">
                        ...
                        <select name="maintenance_status_id" class="selectpicker form-control" 
                            ...
                            <option disabled selected>Choose one...</option>
                            <?php $__currentLoopData = $maintenanceReasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $maintenanceReason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($maintenanceReason->id); ?>"><?php echo e($maintenanceReason->english_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select> 
                    </fieldset>
                </div>
...
<?php echo $__env->make('ticket.show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    function DataTableContent() {
        ...
        table = $('.data-table-all-maintenance').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('all-maintenance.index')); ?>",
                data: function (d) {
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\public_html\comet-me\resources\views/ticket/index.blade.php ENDPATH**/ ?>