            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="POST" enctype='multipart/form-data' id="exportFormWaterHolder"
                        action="{{ route('other-holder.export') }}">
                        @csrf
                        <div class="card-body"> 
                            <div class="row">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="d-flex gap-2">
                            <div style="margin-top:18px">
                                ...
                                @include('holders.activist.create')
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="d-flex gap-2">
                            <div style="margin-top:18px">
                                ...
                                @include('holders.internal.create')
                            </div>
                        </div>
                    </div>
...
@include('holders.town.view')
@include('holders.activist.view')
@include('holders.internal.view')
<script>
    ...
    $(function () {
        ...
        function initActivistHoldersTable() {
            ...
            tables.activist = $('.data-table-activist-holder').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('activist-holder.index') }}",
                    data: function (d) {
                        d.search = (d.search && d.search.value) ? d.search.value : '';
        ...
        function initInternalHoldersTable() {
            ...
            tables.internal = $('.data-table-internal-holder').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('internal-holder.index') }}",
                    data: function (d) {
                        d.search = (d.search && d.search.value) ? d.search.value : '';
                        d.town_community = $('#filterByCommunity').val();
                    }
        ...
        $('#townHoldersTable').on('click', '.updateTownHolder',function() {
            ...
            var id = $(this).data('id');
            var url = "{{ url('town-holder') }}/" + id + "/edit";
        ...
        $('#activistHoldersTable').on('click', '.updateActivistHolder',function() {
            ...
            var id = $(this).data('id');
            var url = "{{ url('activist-holder') }}/" + id + "/edit";
            window.location.href = url;
        });
        ...
        $('#internalHoldersTable').on('click', '.updateInternalHolder',function() {
            ...
            var id = $(this).data('id');
            var url = "{{ url('internal-holder') }}/" + id + "/edit";
            window.location.href = url;
        });
