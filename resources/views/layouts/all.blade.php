...
<!-- Highlight form selects and dropdown lists for better visibility -->
<style>
    /* Visible border for form-select controls */
    .form-select {
        border: 2px solid #0d6efd !important;
        box-shadow: 0 0 0 0.12rem rgba(13,110,253,0.10) !important;
        border-radius: .375rem !important;
    }

    /* Select2: selection box and opened dropdown */
    ...
    /* Highlight focused / hovered options */
