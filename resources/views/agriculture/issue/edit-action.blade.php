...
@section('title', 'edit agriculture action')
...
<div class="card">
    <div class="card-content collapse show">
        <div class="card-body">
            <form method="POST" action="{{route('agriculture-action.update', $agricultureAction->id)}}"
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <fieldset class="form-group">
                            ...
                            <input type="text" name="english_name" class="form-control" 
                                value="{{$agricultureAction->english_name}}">
                        </fieldset>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <fieldset class="form-group">
                            ...
                            <input type="text" name="arabic_name" class="form-control"
                                value="{{$agricultureAction->arabic_name}}" >
                        </fieldset>
                    </div>
                </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <fieldset class="form-group">
                            ...
                            <select name="action_category_id" data-live-search="true"
                                ...
                                @if($agricultureAction->action_category_id)
                                    <option value="{{$agricultureAction->action_category_id}}">
                                        {{$agricultureAction->ActionCategory->english_name}}
                                    </option>
                                @endif 
