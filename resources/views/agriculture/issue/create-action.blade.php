...
<div id="createActionAgriculture" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype='multipart/form-data' id="agricultureActionForm"
                    action="{{url('agriculture-action')}}">
                    @csrf
                    <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#agricultureActionForm').on('submit', function (event) {

            var issueValue = $('#agricultureActionValue').val();
