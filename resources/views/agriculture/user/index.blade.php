                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        @endif
                                                ...
                                                @if(isset($agricultureSystemCycles))
                                                    @foreach($agricultureSystemCycles as $c)
                    ...
                    <div class="d-flex gap-2">
                        ...
                        document.getElementById('exportSmartBtn').addEventListener('click', function () {
                            ...
                            window.location.href = "{{ route('argiculture-user.export-smartboard') }}";
                        });
                        </script>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <!-- <a href="{{ route('argiculture-user.destroy', $holder->id) }}" class="text-decoration-none ms-2" title="Delete" onclick='event.preventDefault(); deleteHolder({{ $holder->id }}, {!! json_encode($holder->household->english_name ?? 'N/A') !!})'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="#" class="text-decoration-none" title="Move to Progress" data-action="move-to-progress" data-holder-id="{{ $holder->id }}" data-holder-name="{{ $holder->household->english_name ?? 'N/A' }}">
                                            <i class="fa-solid fa-arrow-right text-info fs-5"></i>
                                        </a>
                                        <a href="#" class="text-decoration-none ms-2" title="Revert to Requested" data-action="revert-to-requested" data-holder-id="{{ $holder->id }}" data-holder-name="{{ $holder->household->english_name ?? 'N/A' }}">
                                            <i class="fa-solid fa-arrow-rotate-left text-secondary fs-5"></i>
                                        </a>
                                        <a href="#" class="text-decoration-none ms-2" title="Delete" data-action="delete-holder" data-holder-id="{{ $holder->id }}" data-holder-name="{{ $holder->household->english_name ?? 'N/A' }}">
                                            <i class="fas fa-trash text-danger fs-5"></i>
                                        </a>
                                        @endif
                                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="#" class="text-decoration-none me-2" title="Generate QR" onclick="generateQRCode({{ $holder->id }})">
                                        ...
                                        <a href="#" class="btn btn-sm btn-success" title="Mark Complete" data-action="mark-complete" data-holder-id="{{ $holder->id }}" data-holder-name="{{ $holder->household->english_name ?? 'N/A' }}">
    ...
    document.getElementById('exportBtn').addEventListener('click', function () {
        ...
        const url = "{{ route('argiculture-user.export') }}" + (params.toString() ? ('?' + params.toString()) : '');
    ...
    document.getElementById('downloadAllQrBtn').addEventListener('click', function () {
        ...
        window.location.href = "{{ route('argiculture-user.download-all-qrcodes') }}";
    });
    </script>
