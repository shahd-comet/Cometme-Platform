                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <p class="form-control-plaintext">{{ $agricultureUser->size_of_herds ?? '—' }} sheep</p>
                            </div>
                            <div class="col-md-4">
                            ...
                            <!--    <p class="form-control-plaintext">{{ ($agricultureUser->azolla_unit && $agricultureUser->size_of_herds && ($agricultureUser->azolla_unit != ceil($agricultureUser->size_of_herds/25))) ? 'Manual' : 'Automatic' }}</p>-->
                            <!--</div>-->
                        </div>
                    </div>
                                ...
                                <select class="form-select @error('selected_system_ids') is-invalid @enderror" id="selected_system_ids" name="selected_system_ids[]" multiple>
                                    @if(isset($agricultureSystems) && $agricultureSystems->count())
                                        ...
                                        @foreach($agricultureSystems as $sys)
                                            <option value="{{ $sys->id }}" {{ (collect($selected)->contains($sys->id)) ? 'selected' : '' }}>{{ $sys->name ?? optional($sys->azollaType)->name ?? 'System #' . $sys->id }}</option>
                                        @endforeach
                                    @else
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <p class="form-control-plaintext">{{ $agricultureUser->size_of_cow ?? 0 }}</p>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Camels</label>
                                        <p class="form-control-plaintext">{{ $agricultureUser->size_of_camel ?? 0 }}</p>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Chickens</label>
                                        <p class="form-control-plaintext">{{ $agricultureUser->size_of_chicken ?? 0 }}</p>
                                    </div>
                                </div>
                            </div>
