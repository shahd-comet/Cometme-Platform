            ...
            <div class="col-md-4">
                <div class="card text-white bg-primary">
                    <div class="card-body">
                        ...
                        <h3 class="card-text">{{ $totalInstalled ?? 0 }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-white bg-success">
                    <div class="card-body">
                        ...
                        <h3 class="card-text">{{ $totalHolders ?? 0 }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-white bg-warning">
                    <div class="card-body">
                        ...
                        <h3 class="card-text">{{ $totalReturned ?? 0 }}</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">{{ $componentsLost ?? 0 }} (placeholder — will use new components table)</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">{{ $componentsReused ?? 0 }} (placeholder — will use new components table)</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="d-flex align-items-start justify-content-between">
                    ...
                    <div>
                        @if(Auth::guard('user')->user()->user_type_id == 1 || 
                            ...
                            Auth::guard('user')->user()->user_type_id == 10 ||
                            Auth::guard('user')->user()->user_type_id == 13)
                            <a class="btn btn-success" href="{{ route('internet.returns.create') }}">Create Removed Record</a>
                        @endif
                    </div>
                </div>
